...
function initialize() {
  if (GBrowserIsCompatible()) {
    ...
    selectHtml += "<option value='https://www.javadrive.jp/google-maps-javascript/data/js/data/toei-asakusa.json'>浅草線</option>";
    selectHtml += "<option value='https://www.javadrive.jp/google-maps-javascript/data/js/data/toei-mita.json'>三田線</option>";
    selectHtml += "<option value='https://www.javadrive.jp/google-maps-javascript/data/js/data/toei-shinjyuku.json'>新宿線</option>";
    selectHtml += "<option value='https://www.javadrive.jp/google-maps-javascript/data/js/data/toei-ooedo.json'>大江戸線</option>";
    selectHtml += "</select>";
    selectHtml += "</form>";
